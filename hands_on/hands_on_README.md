...
- `01_ec2_web_app/` - a small dynamic Flask app deployed on an EC2 instance inside a custom VPC. Ties to Chapter 1 (AWS Cloud Fundamentals) - IaaS, virtualization, and the VPC/security-group Deeper Dive material.
