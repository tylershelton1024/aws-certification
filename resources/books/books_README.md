...
Study material organized per book, so multiple books - for the same certification or different ones - can coexist without mixing.
...
- `cloud_practitioner_boghosians/` - primary source for AWS Certified Cloud Practitioner (CLF-C02) prep.
