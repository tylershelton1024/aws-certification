...
const chapter01Decks = {
  ...
  "deeper": [
    ...
    { "term": "SSH Key Pair", "definition": "A public/private key pair used to log into a server instead of a password. AWS keeps the public half; you download and keep the private half (a .pem file). Whoever holds that file can log in - never commit it to a repo." },
